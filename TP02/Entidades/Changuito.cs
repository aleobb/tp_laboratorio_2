...
namespace Entidades_2017
{
    ...
    public sealed class Changuito
    {
        ...
        /// <summary>
        /// Constructor privado solo accesible desde la clase, inicializa los atributos
        /// </summary>
        private Changuito()
        {
        ...
        /// <summary>
        /// Constructor publico, recibe el valor de espacioDisponible y lo carga
        /// </summary>
        ...
        public static Changuito operator +(Changuito c, Producto p)
        {
            foreach (Producto v in c._productos)
            {
                if (c._productos.Count >= c._espacioDisponible || v == p )
                    return c;
            }
            c._productos.Add(p);
            return c;
